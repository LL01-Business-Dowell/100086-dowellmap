...
//        val testData: TestData? = null,
        ...
        @SerializedName("radius_distance_from") val radiusDistanceFrom: String? = null,
        @SerializedName("radius_distance_to") val radiusDistanceTo: String? = null,

        //log custom data
        @SerializedName("req_type") val reqType: String? = null,
        @SerializedName("mongo_id") val mongoId: String? = null,
